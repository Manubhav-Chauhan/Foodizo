...
const RestaurantList = ({ searchQuery, onAddToCart, onAddToFavorites, favorites, currentUser }) => {
  ...
  const restaurants = [
    ...
    },
    {
      id: 2,
      name: "Domino's Pizza",
      image: "https://plus.unsplash.com/premium_photo-1667682942059-33ee7a49cb28?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1yZWxhdGVkfDI0fHx8ZW58MHx8fHx8",
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1563379091339-03b21ab4a4f8?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1yZWxhdGVkfDE1fHx8ZW58MHx8fHx8",
